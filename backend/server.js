...
const reviewRoutes = reviewRoutesModule
  ? reviewRoutesModule.router || reviewRoutesModule
  : null;
...
async function processAITutorMessage(data) {
  ...
  return {
    message:
      "I understand you're working on this problem. Let me help you break it down...",
    suggestions: [
