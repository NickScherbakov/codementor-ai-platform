...
router.post("/register", [
  ...
  try {
    ...
    await user.save();
    await ensureProgressDocument(user.id);
...
router.post("/forgot-password", [
  ...
  try {
    ...
    const resetLink = publicAppUrl
      ? `${publicAppUrl.replace(/\/$/, "")}/reset-password?token=${resetToken}`
      : "Configure PUBLIC_APP_URL or FRONTEND_URL to generate reset links.";
